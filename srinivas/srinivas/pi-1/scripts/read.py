        ...
        try:
            ...
            with open(file_path, 'r') as file:
                ...
                if c == l:
                    ...
                    command = ["python3", "/opt/human-detection/compress_filereceiver.py"]
                    ...
                    command2 = ["python3", "/opt/human-detection/resize_image_QoE.py"]
...
while True:
	read_file_forever('/opt/human-detection/Compression_token.txt')
