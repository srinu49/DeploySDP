        ...
        try:
            ...
            with open(file_path, 'r') as file:
                ...
                if c == l:
                    ...
                    command = ["python3", "/opt/human-detection/cmsd_publish.py"]
                ...
                if c == r:
                    ...
                    command2 = ["python3", "/opt/human-detection/angel_publish.py"]
...
while True:
	read_file_forever('/opt/human-detection/Redirect.txt')
