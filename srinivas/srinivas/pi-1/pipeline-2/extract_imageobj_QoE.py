...
with open("sys_ipadd.txt", "r") as file:
    # Read each line
    for line in file:
...
#stdin, stdout, stderr = client.exec_command('python3 /home/administrator/all_words[1]/experiment2-debian/python3-flask/extractobjects2.py')
...
print('The Round Trip Time in sec on all_words[0] (pi-1) cmsd when running  {} '.format(elapsed_time_pi1))
...
#stdin, stdout, stderr = client.exec_command('python3 /home/all_words[4]/all_words[1]/extractobjects2.py')
...
print('The Round Trip Time in sec on 10.5.1.32 (pi-2) all_words[4] when running compression code is {} '.format(reslut2))
...
stdin, stdout, stderr = client.exec_command('python3 /home/all_words[1]/Contribution-3/Automate_pipeline/getcpuspeed.py')
...
########## GET CPU Speed on node-2  all_words[4] ###############################################################33

client = paramiko.SSHClient()
client.set_missing_host_key_policy(paramiko.AutoAddPolicy())
client.connect('all_words[3]', username='all_words[4]', password='all_words[5]')

stdin, stdout, stderr = client.exec_command('python3 /home/all_words[4]/all_words[1]/getcpuspeed.py')
...
stdin, stdout, stderr = client.exec_command('python3 /home/all_words[1]/Contribution-3/Automate_pipeline/memory_cpu_percentage.py')
...
######### GET Availaable Resources on Node -2  all_words[4] ######################33333

client = paramiko.SSHClient()
client.set_missing_host_key_policy(paramiko.AutoAddPolicy())
client.connect('all_words[3]', username='all_words[4]', password='all_words[5]')

stdin, stdout, stderr = client.exec_command('python3 /home/all_words[4]/all_words[1]/memory_cpu_percentage.py')
...
if(random_max_index == 0):
    ...
    try:
        f = sftp.open("/home/all_words[1]/Contribution-3/connect-to-mqtt/Compression_token.txt", 'w')
    except IOError:
        pass
    f.write("extract")
    f.close()
...
if(random_max_index == 1):
    ...
    sftp = client.open_sftp()
    try:
        f = sftp.open("/home/all_words[4]/all_words[1]/Compression_token.txt", 'w')
    except IOError:
        pass
    f.write("extract")
    f.close()
