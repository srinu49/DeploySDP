        ...
        try:
            ...
            with open(file_path, 'r') as file:
                ...
                if c == l:
                    ...
                    command = ["python3", "/home/pi-cv-101/pipeline-2/cmsd_publish.py"]
                ...
                if c == r:
                    ...
                    #command = ["python3", "/home/pi/pipeline-2/image-resizese-sendFog.py"]
                    #subprocess.Popen(command)

                    # Run the QoE Alo to place next task

                    command2 = ["python3", "/home/pi-cv-101/pipeline-2/angel_publish.py"]
                    k=subprocess.Popen(command2)
                    try:
                        k.wait()
                    finally:
                        k.kill()
...
while True:
	read_file_forever('/home/pi-cv-101/pipeline-2/Redirect.txt')
